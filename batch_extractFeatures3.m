filenames={'circleRotation', 'circleTranslation', 'circleZoom', 'cupUdRotation', 'cupUdTranslation', 'cupUdZoom',...
...
filepath = '/nfshomes/barranco/Matlab/border_ownership/background/cluttered background';
