...
for i=1:numel(t)
    ...
    %if pol(i)==1
       It_pos(pty, ptx)=t(i); % put his time in the timetable
    %else
...
% Showing results
% Vy_pos = medianFilter2(Iflotvy_pos, 5, 5);
% Vx_pos = medianFilter2(Iflotvx_pos, 5, 5);
% 
% Vy_neg = medianFilter2(Iflotvy_neg, 5, 5);
% Vx_neg = medianFilter2(Iflotvx_neg, 5, 5);
