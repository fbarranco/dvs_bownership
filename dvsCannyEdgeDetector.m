function varargout = dvsCannyEdgeDetector(varargin)
...
imi = mat2gray(imi.*BW2);

gra_mag = imi; % The map of last time stamps are normalized [0,1]
%gra_dir = atan2(imy,imx);
gra_dir= featureorient(imi,0,1,0,1).*BW2;
